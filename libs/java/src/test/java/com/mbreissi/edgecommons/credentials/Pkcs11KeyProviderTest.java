 ...
 * {@code EDGECOMMONS_IT_PKCS11=1}; skipped otherwise. Requires these env vars:
...
class Pkcs11KeyProviderTest {
    ...
    void pkcs11BackedVaultRoundTrip(@TempDir Path dir) {
        assumeTrue("1".equals(System.getenv("EDGECOMMONS_IT_PKCS11")),
                "needs a PKCS#11 token (EDGECOMMONS_IT_PKCS11=1)");

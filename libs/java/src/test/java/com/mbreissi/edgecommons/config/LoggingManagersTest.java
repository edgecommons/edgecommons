...
class LoggingManagersTest {
    ...
    @Test
    void loggingConfigurationManagerConfiguresEdgeCommonsNamespace() throws IOException {
        // Includes a edgecommons-namespaced specific logger (the only ones it touches).
        ConfigManager cm = managerFor("""
                {"level":"DEBUG","loggers":{"com.mbreissi.edgecommons.test":"WARN"}}""");
    ...
    @Test
    void loggingConfigurationManagerIgnoresNonEdgeCommonsLoggers() throws IOException {
        ConfigManager cm = managerFor("""
    ...
    void globalLoggingManagerAppliesFullConfigWhenEnabled() throws IOException {
        ...
        ConfigManager cm = managerFor("""
                ...
                "loggers":{"com.mbreissi.edgecommons":"DEBUG"}}""");

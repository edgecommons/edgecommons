...
import com.mbreissi.edgecommons.test.TestableEdgeCommons;
...
class MessageTest {
    ...
    private static TestableEdgeCommons edgeCommons;
    ...
    void setUp() {
        if (edgeCommons == null) {
            ...
            edgeCommons = new TestableEdgeCommons("test.component", args);
        }
    }
    ...
    void testShutdownDoesNotThrow() {
        TestableEdgeCommons local = new TestableEdgeCommons("test.component",
    ...
    void testBuildFromConfigWithCorrelationId() {
        ...
        Message message = Message.buildFromConfig("TestMessage", "1.0", payload, 
                edgeCommons.getConfigManager(), "test-correlation-123");
    ...
    void testBuildFromConfigWithStringPayload() {
        ...
        Message message = Message.buildFromConfig("StringMessage", "2.0", stringPayload, 
                edgeCommons.getConfigManager(), "string-correlation");
    ...
    void testBuildFromConfigWithJsonStringPayload() {
        ...
        Message message = Message.buildFromConfig("JsonStringMessage", "1.5", jsonStringPayload, 
                edgeCommons.getConfigManager(), "json-correlation");

...
/**
 * Unit tests for the root {@link EdgeCommons} facade that do NOT require a broker or native
 * library. They drive the parts the broker-backed {@code EdgeCommonsLifecycleTest} cannot reach:
 * <ul>
 ...
 */
class EdgeCommonsFacadeUnitTest {
    ...
    private static EdgeCommons newBare() throws Exception {
        var ctor = EdgeCommons.class.getDeclaredConstructor();
        ctor.setAccessible(true);
        return ctor.newInstance();
    }

    private static void invokePrivate(EdgeCommons gg, String method) throws Exception {
        Method m = EdgeCommons.class.getDeclaredMethod(method);
    ...
    void deprecatedTwoArgConstructorWrapsInitFailure() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class,
                () -> new EdgeCommons("com.test.Dep2", new String[]{"--platform", "GREENGRASS"}));
    ...
    void deprecatedThreeArgConstructorWrapsInitFailure() {
        ...
        assertThrows(RuntimeException.class,
                () -> new EdgeCommons("com.test.Dep3", new String[]{"--platform", "GREENGRASS"}, opts));
    }
    ...
    void deprecatedFourArgConstructorWrapsInitFailure() {
        org.apache.commons.cli.Options opts = new org.apache.commons.cli.Options();
        assertThrows(RuntimeException.class,
                () -> new EdgeCommons("com.test.Dep4", new String[]{"--platform", "GREENGRASS"}, opts, false));
    }

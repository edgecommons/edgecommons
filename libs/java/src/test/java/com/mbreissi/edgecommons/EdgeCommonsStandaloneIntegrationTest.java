...
/**
 * End-to-end STANDALONE bring-up of {@link EdgeCommons} against an in-process Moquette broker.
 * Covers EdgeCommons.init in STANDALONE mode wiring the config manager, messaging client (dual
 ...
 */
class EdgeCommonsStandaloneIntegrationTest {
    ...
    static void setup() throws Exception {
        ...
        gg = EdgeCommonsBuilder.create("com.test.StandaloneComponent").withArgs(args).build();
    }
    ...
    void deprecatedConstructorBringsUpStandalone() {
        ...
        EdgeCommons legacy = new EdgeCommons("com.test.LegacyComponent", args);
        try {

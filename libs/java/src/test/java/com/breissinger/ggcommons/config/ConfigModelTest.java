...
class ConfigModelTest {
    ...
    void loggingConfigurationFullyPopulatedAndToString() {
        ...
        assertEquals("WARN", cfg.getLoggerLevels().get("com.breissinger").toString());
        ...
        assertEquals("WARN", dict.getAsJsonObject("loggers").get("com.breissinger").getAsString());

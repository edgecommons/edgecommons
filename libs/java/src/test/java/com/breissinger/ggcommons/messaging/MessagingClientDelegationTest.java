...
class MessagingClientDelegationTest {
    ...
    private static com.breissinger.ggcommons.config.ConfigManager tagOnlyConfig() {
        com.breissinger.ggcommons.config.ConfigManager cm =
                mock(com.breissinger.ggcommons.config.ConfigManager.class);

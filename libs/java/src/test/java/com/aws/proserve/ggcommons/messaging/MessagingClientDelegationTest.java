...
class MessagingClientDelegationTest {
    ...
    private static com.aws.proserve.ggcommons.config.ConfigManager tagOnlyConfig() {
        com.aws.proserve.ggcommons.config.ConfigManager cm =
                mock(com.aws.proserve.ggcommons.config.ConfigManager.class);

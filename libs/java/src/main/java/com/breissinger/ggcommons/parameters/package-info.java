 ...
 *
 * <p>The source is pluggable ({@link com.breissinger.ggcommons.parameters.ParameterSource}):
 ...
 * (reusing the credentials {@link com.breissinger.ggcommons.credentials.LocalVault} on-disk format)

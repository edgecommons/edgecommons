...
import com.mbreissi.ggcommons.utils.Utils;
...
final class ShadowConfigProvider extends ConfigProvider implements  StreamResponseHandler<SubscriptionResponseMessage>
{
    ...
    private void reportUpdatedConfiguration(String componentConfig)
    {
        ...
        LOGGER.trace("Updating com.mbreissi.ggcommons.config to:{}", componentConfig);
    ...
    {
        LOGGER.info("configurationChanged: Applying new com.mbreissi.ggcommons.config: {}", newConfig);

...
public class ConfigManagerFactory {
     ...
     * {@link com.mbreissi.ggcommons.platform.PlatformResolver#resolveIdentity} (DESIGN-core §6.2
    ...
    private static String resolveThingName(ParsedCommandLine cmdLine) {
        return com.mbreissi.ggcommons.platform.PlatformResolver.resolveIdentity(

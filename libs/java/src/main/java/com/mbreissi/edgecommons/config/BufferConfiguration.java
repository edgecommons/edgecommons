 ...
 * embedded edgestreamlog disk buffer and drained to {@code PutMetricData} via a host-callback sink
...
public final class BufferConfiguration {
    ...
    private static final String DEFAULT_PATH = "/var/lib/edgecommons/metrics/{ComponentName}/cw";

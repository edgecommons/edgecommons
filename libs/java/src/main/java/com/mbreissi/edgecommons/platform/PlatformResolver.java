 ...
 * KUBERNETES Downward-API tier ({@code EDGECOMMONS_THING_NAME}, then {@code POD_NAME}) ahead of the
 ...
 * downstream (the logging configurator and {@link com.mbreissi.edgecommons.EdgeCommons} respectively).
 *
...
public final class PlatformResolver {
     ...
     * {@code edgecommons.io/thing-name} pod annotation (or an explicit value) into this var. Highest of
     * the KUBERNETES identity tier, ahead of {@link #ENV_K8S_POD_NAME}.
     */
    public static final String ENV_K8S_THING_NAME = "EDGECOMMONS_THING_NAME";
    /**
     ...
     */
    public static final String CONFIGMAP_DEFAULT_MOUNT_DIR = "/etc/edgecommons";
     ...
     * ({@link com.mbreissi.edgecommons.config.ConfigManager#reconfigureLogging}): the resolved
     ...
     * {@link com.mbreissi.edgecommons.EdgeCommons}: an explicit {@code health.enabled} from the config
     ...
     * {@link com.mbreissi.edgecommons.metrics.MetricEmitter}: an explicit {@code metricEmission.target}
     ...
     * {@link com.mbreissi.edgecommons.credentials.Credentials#open(com.google.gson.JsonObject, String, String)}
     ...
     *       {@link #ENV_K8S_THING_NAME} ({@code EDGECOMMONS_THING_NAME}) then {@link #ENV_K8S_POD_NAME}
     *       ({@code POD_NAME});</li>
     ...
     * ({@link com.mbreissi.edgecommons.config.ConfigManager#resolveTemplate}) wherever it is

...
public final class StreamHandle implements AutoCloseable {
    ...
    StreamHandle(EdgeStreamNative n, MemorySegment stream, String name) {
        this.n = n;
        this.stream = stream;
        this.name = name;
    }
     ...
     * @throws EdgeStreamException on a buffer/IO/sink error (e.g. {@code ERR_FULL} under rejectNew)
     */

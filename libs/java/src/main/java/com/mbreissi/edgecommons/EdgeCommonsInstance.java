 ...
 *
 * <p>Obtain handles from {@link EdgeCommons#instance(String)} (validated + cached per id).
...
public final class EdgeCommonsInstance {
    ...
    /**
     * Package-private: created by {@link EdgeCommons#instance(String)}, which validates the token
     ...
     */
    EdgeCommonsInstance(String id, ConfigManager configManager, boolean includeRoot,

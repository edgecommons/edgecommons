 ...
 *
 * <p>The source is pluggable ({@link com.aws.proserve.ggcommons.parameters.ParameterSource}):
 ...
 * (reusing the credentials {@link com.aws.proserve.ggcommons.credentials.LocalVault} on-disk format)

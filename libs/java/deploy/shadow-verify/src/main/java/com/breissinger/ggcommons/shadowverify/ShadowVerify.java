package com.breissinger.ggcommons.shadowverify;
 ...
 * ({@code com.ggcommons.JavaShadowVerify} -> {@code com_ggcommons_JavaShadowVerify}),
...
public final class ShadowVerify {
    private static final String COMPONENT = "com.ggcommons.JavaShadowVerify";
    private static final String RESULT = "/tmp/java_shadow_verify_result.json";

    public static void main(String[] args) {
        try {
            GGCommons gg = GGCommonsBuilder.create(COMPONENT).withArgs(args).build();

"""The seam :class:`~ggcommons.facades.data_facade.DataFacade` composes to route a
...
When streaming is not configured (``get_streams() is None``), :class:`~ggcommons.GGCommons`

...
:class:`~ggcommons.facades.data_facade.DataFacade` defaults an omitted sample quality to
...
Mirrors Java's ``Quality`` enum (``com.mbreissi.ggcommons.facades.Quality``).
"""

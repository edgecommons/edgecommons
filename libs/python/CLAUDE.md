...
- Per-feature docs live in `doc/` (`architecture.md`, `messaging.md`, `configuration.md`, `metric-emission.md`, `heartbeat.md`, `logging.md`, `builder-patterns.md`, `dependency-injection.md`, `configuration-validation.md`, `migration-guide.md`, `command-line-options.md`). Update the relevant doc when changing a subsystem's public behavior.
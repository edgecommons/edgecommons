...
:class:`~edgecommons.facades.channel.Channel`. It publishes through the **ordinary,
...
class DataFacade:
    ...
    def signal(self, signal_id: Optional[str]) -> SignalUpdateBuilder:
        ...
        :meth:`~edgecommons.facades.signal_update.SignalUpdateBuilder.publish`.
    ...
    def publish_update(self, update: SignalUpdate) -> None:
        """Publishes a built :class:`~edgecommons.facades.signal_update.SignalUpdate`:
    ...
    def build_body(self, update: SignalUpdate) -> Dict[str, Any]:
        ...
        :class:`~edgecommons.facades.signal_update.SignalUpdate`, applying the §2.1

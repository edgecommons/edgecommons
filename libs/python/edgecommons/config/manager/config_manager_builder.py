...
from edgecommons.config.manager.config_component_manager import ConfigComponentManager
...
from edgecommons.config.manager.greengrass_config_manager import GreengrassConfigManager
from edgecommons.config.manager.shadow_config_manager import (
    ShadowConfigManager,
    _sanitize_shadow_name,
)
from edgecommons.platform.platform import Platform
from edgecommons.platform.resolver import resolve_identity
...
class ConfigManagerBuilder:
    ...
    def build(args: Namespace, component_name: str) -> ConfigManager:
        ...
        # The resolved platform (set on the namespace by EdgeCommons after resolve_profile). Threaded

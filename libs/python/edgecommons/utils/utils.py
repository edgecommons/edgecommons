"""
General utility functions for edgecommons.

This module provides common utility functions used throughout the edgecommons library.
...
from edgecommons.utils.deprecation import deprecated, warn_deprecated

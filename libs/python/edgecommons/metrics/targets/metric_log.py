...
from edgecommons.platform.resolver import profile_metric_log_path
...
class MetricLog(MetricTarget):
    def __init__(self, config_manager: ConfigManager):
        ...
        # file metrics rather than aborting EdgeCommons init — matching the Java/Rust/TS log targets.
        self._enabled = False

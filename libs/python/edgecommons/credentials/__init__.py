...
Example::
    ...
    creds = open_from_config({"vault": {"path": "/var/lib/edgecommons/vault"}})
...
from .keyprovider import EnvKeyProvider, FileKeyProvider, KeyProvider, KmsKeyProvider, Pkcs11KeyProvider

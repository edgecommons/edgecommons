...
EdgeCommons sink component (Rust), `<<COMPONENTFULLNAME>>`. The full picture — what this component
is, the destination seam, config location, and the org conventions it inherits — lives in

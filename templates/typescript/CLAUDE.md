...
EdgeCommons component (TypeScript). Full name `<<COMPONENTFULLNAME>>`.
The shape, config, and validation expectations live in `AGENTS.md` and are shared with every agent
tool. It is imported here in full:

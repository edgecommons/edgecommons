...
EdgeCommons general-purpose component (Rust), `<<COMPONENTFULLNAME>>`. The full picture — what this
component is, config location, and the org conventions it inherits — lives in `AGENTS.md` and is

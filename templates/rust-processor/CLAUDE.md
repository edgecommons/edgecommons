...
EdgeCommons processing component (Rust), `<<COMPONENTFULLNAME>>`. The full picture — what this
component is, the stage seam, config location, and the org conventions it inherits — lives in

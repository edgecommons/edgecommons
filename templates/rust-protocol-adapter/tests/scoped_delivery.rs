...
use <<SNAKENAME>>::app::{set_paused, DeviceConfig, DeviceControl, Health, LinkState};
use <<SNAKENAME>>::commands::{register_all, DeviceHandle, VERBS};
use <<SNAKENAME>>::device::SignalInfo;
use <<SNAKENAME>>::metrics::DeviceMetrics;

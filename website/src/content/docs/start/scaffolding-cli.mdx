...
ggcommons = { git = "https://github.com/mbreissi/ggcommons", tag = "rust-lib/v0.1.0", default-features = false }
```
...
branch is never reached. {/* NEEDS REVIEW: this reflects upgrade.py keying on "ggcommons" while the TS template emits "@mbreissi/ggcommons"; the CLI should be fixed to recognize the scoped package name for parity. */}

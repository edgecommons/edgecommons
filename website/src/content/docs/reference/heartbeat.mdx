...
class HeartbeatConfiguration:
    ...
    def get_destination(self) -> str: ...      # "local" | "northbound"
```
...
impl HeartbeatConfig {
    ...
    pub fn destination(&self) -> &str;   // resolved ("local" | "northbound")
}
...
export class HeartbeatConfig {
  ...
  destination: string;     // "local" (default) | "northbound" — the state keepalive only
}

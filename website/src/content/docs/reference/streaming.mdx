...
[Configuration reference](/reference/configuration/#streaming).
...
<LinkCard title="Configuration reference: streaming section" href="/reference/configuration/#streaming" description="Every streaming.streams[] field, with defaults and validation rules." />

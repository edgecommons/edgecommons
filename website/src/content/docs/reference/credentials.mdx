...
`credentials` config section lives in the [config schema reference](/reference/config-schema/).
...
- [Config schema reference](/reference/config-schema/) — every `credentials` field, default, and
  validation rule.

...
classes, the consumer wildcard pattern — read the [Unified Namespace guide](/guides/unified-namespace/)
...
Same convention as `uns()`/`instance()` above: a component-level convenience (no instance token) and an
...
<LinkCard
  ...
  description="The concept: the grammar, the eight classes, identity + hierarchy, and the consumer wildcard pattern."
/>
